(function (global, factory) {
  ...
  const createSuspenseQuery = options => {
  ...
  const createInfiniteQuery = options => {
  ...
  const createMutation = defaultOptions => {
