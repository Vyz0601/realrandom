...
with_node \
  ...
  --target "/Users/hoangvy/OtherProject/test-new=blank-project/MyApp/ios/Pods/Target Support Files/Pods-MyApp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-eas-client" "expo-file-system" "expo-image" "expo-keep-awake" "expo-localization" "expo-router" "expo-system-ui" "expo-updates"
